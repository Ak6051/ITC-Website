...
//   // ✅ Correct Axios route call
//   useEffect(() => {
//     const fetchJobs = async () => {
//       try {
//         const response = await axios.get('http://localhost:5000/api/employer/all-jobs');   // ✅ Make sure route matches backend
...
//     { field: 'educationalQualification', headerName: 'Qualification', width: 200 },
...
//     // ✅ Directly access employer fields
...
const EmployerDataGrid = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(
        `http://localhost:5000/api/employer/delete-job/${selectedJob.userId}/${selectedJob.jobId}`
      );
