...
// //             Tell Us Your Professional Details & Get Matching Job Offers
// //           </Typography>
...
// //             <Button variant="contained" color="secondary" onClick={() => navigate("/candidate-register")}>
// //               Back
// //             </Button>
...
//           <input type="file" name="resume" onChange={handleInputChange} style={{ margin: "16px 0", display: "block" }} />
