...
//     if (!formData.companyAddress) tempErrors.location = 'Location is required';
...
//                   <TextField label="Company Address" name="companyAddress" fullWidth onChange={handleChange} error={!!errors.companyAddress} helperText={errors.companyAddress} margin="normal" />
...
const EmployerRegister = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.mobileNo.trim())
      ...
      tempErrors.mobileNo = 'Enter a valid 10-digit Mobile No';
            ...
            >
              <CardContent>
                ...
                <Typography
                  variant="h4"
                  align="center"
                  sx={{ fontWeight: 'bold', color: '#203A43', mb: 3 }}
                >
                  Register Employer
                </Typography>
                <Divider sx={{ mb: 3 }} />
