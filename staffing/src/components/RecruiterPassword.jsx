    ...
    const handleSubmit = async (values, { resetForm }) => {
        try {
            const res = await axios.put(
                "http://localhost:5000/api/fetch/change-password",
                {
  ...
  return (
    ...
    <Grid container component="main" sx={{ height: "100vh" }}>
      ...
      <Grid
        item xs={12} sm={6}
        sx={{
          backgroundImage: "url(https://source.unsplash.com/600x800/?security,password)",
            ...
            {({ errors, touched, isSubmitting }) => (
              <Form style={{ width: "100%", maxWidth: "400px" }}>
                ...
                <Button
                  ...
                  sx={{ mt: 3, bgcolor: "#ff5722", ":hover": { bgcolor: "#e64a19" } }}
                >
