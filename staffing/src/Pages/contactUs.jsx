...
//           {["Reduce Hiring Risks", "Increase Efficiencies", "Deeper Talent Pools", "Onboarding Support", "Employer Branding", "Industry Knowledge"].map((text, index) => (
//             <Grid item xs={12} sm={6} md={4} key={index}>
//               <Box sx={{ p: 2, bgcolor: "#F5FAFA", borderRadius: "8px", textAlign: "center", boxShadow: "0px 2px 8px rgba(0,0,0,0.1)" }}>
